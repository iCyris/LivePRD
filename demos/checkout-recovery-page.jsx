      ...
      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[1.08fr_0.92fr]">
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            <h1 className="max-w-3xl text-[40px] leading-tight tracking-tight">
              Recover gracefully after checkout timeout without forcing a reset
            </h1>
            <p className="max-w-2xl text-[15px] leading-7 text-[color:var(--prd-muted)]">
          ...
          <Card className="border-[color:var(--prd-border)] bg-[color:var(--prd-panel)] shadow-[var(--prd-shadow)]">
            ...
            <CardContent className="grid gap-4 md:grid-cols-3">
              <div className="rounded-[calc(var(--prd-radius)-2px)] border border-[color:var(--prd-border)] bg-[color:var(--prd-surface)] p-4">
                <TimerReset className="mb-3 h-5 w-5 text-[color:var(--prd-text)]" />
              ...
              <div className="rounded-[calc(var(--prd-radius)-2px)] border border-[color:var(--prd-border)] bg-[color:var(--prd-surface)] p-4">
                <CheckCircle2 className="mb-3 h-5 w-5 text-[color:var(--prd-text)]" />
              ...
              <div className="rounded-[calc(var(--prd-radius)-2px)] border border-[color:var(--prd-border)] bg-[color:var(--prd-surface)] p-4">
                <ArrowRight className="mb-3 h-5 w-5 text-[color:var(--prd-text)]" />
